...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className='relative h-1.5 w-full grow overflow-hidden rounded-full bg-neutral-100 dark:bg-neutral-50/20'>
      <SliderPrimitive.Range className='absolute h-full bg-neutral-600 dark:bg-neutral-50' />
