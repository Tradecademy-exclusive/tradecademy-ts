...
export const Sidebar = () => {
  ...
  return (
    <div className='bg-charcoal w-[300px] rounded-r-2xl py-6 px-7 flex flex-col items-center gap-8 min-h-screen h-full'>
      <Icons.icon />
      <nav className='w-fit flex flex-col items-start gap-6'>
          ...
          Icon={
            ...
            >
              <path
                ...
                className={`
                  ${pathname === '/courses' ? 'fill-tcblue' : 'fill-creme'}
        ...
        <NavLink
          Icon={
            <BsJournalText
              className={`text-xl group-hover:text-tcblue transition-all duration-300 ${
                pathname === '/plan' ? 'text-tcblue' : 'text-creme'
              }`}
            />
          }
          label='Trading Plan'
          ...
          Icon={
            ...
            >
              <rect
                ...
                rx='1.5'
                className={`
                  ${pathname === '/journal' ? 'stroke-tcblue' : 'stroke-creme'}
          ...
          Icon={
            ...
            >
              <path
                ...
                className={`
                  ${pathname === '/homework' ? 'fill-tcblue' : 'fill-creme'}
                   group-hover:fill-tcblue transition-all duration-300`}
              />
            </svg>
          }
          ...
          Icon={
            ...
            >
              <rect
                ...
                rx='1.5'
                className={`
                  ${pathname === '/signals' ? 'stroke-tcblue' : 'stroke-creme'}
                   group-hover:stroke-tcblue transition-all duration-300`}
              />
              <line
                x1='1'
